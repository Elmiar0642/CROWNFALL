...
int cf_get_active_houses_api(CfGame *game, const CfHouse **out, int max);
const char *cf_get_piece_identity_api(CfGame *game, int piece_id);
const char *cf_get_player_identity_api(CfGame *game, int player_id);
